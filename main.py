...
def startGame():
    ...
    resetinventory = {
        ...
        "randomItems": [],
        "unlocks": [],
        "locations": {"keylocation": "", "otherlocation": ""},
        "code": {
        ...
        "otherdata": {"room2": [], "table": [], "difficulty": 0},
    }
    ...
    while True:
        ...
        if "sidedeath" in inventoryshow["unlocks"]:
            ...
            print(
                random.choice(
                    [
                        "OMG! is is that {} are they dead omg\n* You start running to the exit*\nif i dont get out now im next",
                        "IS IS that {} *You nearly faint*\nthere arm is on the other side of the rooms,\nif i dont get our now im nexrt",
                    ]
                ).format(sideCharacter)
            )
        ...
        if userInput.lower() == "help":
            ...
            if "Key (Room 1)" in inventoryshow["items"]:
                ...
                print(
                    random.choice(
                        [
                            "You try to open the door, it rattles. you need a key!",
                            "Theres a key hole, maybe you need a key for this room",
                            "This door wont budge without a key!",
                        ]
                    )
                )
            ...
            print(
                random.choice(
                    [
                        ...
                        "\nTheres a keypad maybe i dont need a key for this",
                    ]
                )
            )
            while True:
...
def roomA():
    ...
    Room1.Room1Start(
        ...
        difficulty,
        escapeDoorLocation,
    )  # all the data that the room will need is parsed in
