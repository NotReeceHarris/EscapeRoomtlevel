...
def Room3Start(
    ...
    while True:
        if specialRoom == roomName1:
            specialRoom = True
        UserInput = input(
            str(commandLine.format(roomName3))
        ...
        if UserInput.lower() == "help":
            ...
            if inventoryitem1["locations"]["keylocation"] == "item1room3":
                if "item1room3" in inventoryitem1["unlocks"]:
                    ...
                    print(
                        random.choice(
                            [
                                "Whats this a peice of paper, it has scribbles all over it, wait there something on the back '{}' does this mean something",
                                "scribbles? who did this, is it ment to be art?, wait it says '{}' on the back",
                            ]
                        ).format("Decrypt table part 1")
                    )
            ...
            if "skull" in inventoryitem4["unlocks"]:
                ...
                print(
                    random.choice(
                        [
                            "right it says {} on it i should remember it!",
                            "it has {} carved into it i have already seen this",
                            "iv already seen this it says {} on it",
                        ]
                    ).format(inventoryitem4["code"]["room4cabnet"])
                )
            else:
                print(dialog["clear"])
                print(
                    random.choice(
                        [
                            "ah finally something simple it says {} on the top of it",
                            "damn who carved {} into it",
                            "i should remeber this carving {}",
                        ]
                    ).format(inventoryitem4["code"]["room4cabnet"])
                )
