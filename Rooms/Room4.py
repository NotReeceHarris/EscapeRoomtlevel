...
def Room4Start(
    ...
    print(f"\n{random.choice(dialog[f'{scene}{roomName4}'])}")
    currentItems = []
    ...
    while True:
        ...
        if x == y or y == x:
            ...
            with open(jsonInventory, "r") as e:
                inventoryreset = json.load(e)
            inventoryreset["items"].append("Decrypt table part 1")
            inventoryreset["items"].append("Decrypt table part 2")
    ...
    while True:
        if specialRoom == roomName4:
            specialRoom = True
        UserInput = input(
            str(commandLine.format(roomName4))
        ...
        if UserInput.lower() == "help":
            ...
            if "Decrypt table part 1" in inventoryitem5["items"]:
                ...
                print(
                    random.choice(
                        [
                            "\nYou put the peice on the table, Lets hope it matches the others",
                            "\nYou place the peice on the table, Lets hope it matches the others",
                            "\nIl put this peice on the table maybe the others are in the next room",
                        ]
                    )
                )
            ...
            if (
                ...
                print(
                    random.choice(
                        [
                            "So with all the peices together it reads out this",
                            "well i wasnt expecing all the peices to be this",
                            "all the peices together make this table? huh",
                        ]
                    )
                )
                table = """
                THE RDKE DECRYPTION TABLE
