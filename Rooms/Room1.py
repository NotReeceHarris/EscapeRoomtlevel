...
def Room1Start(
    ...
    while True:
        ...
        if specialRoom == roomName1:
            specialRoom = True
        UserInput = input(
            str(commandLine.format(roomName1))
        ...
        if UserInput.lower() == "help":
            ...
            print(
                "storageunit -> Inspect storage unit\n\n    --------------------------\n"
            )
            ...
            if inventoryitem1["locations"]["keylocation"] == "item1room1":
                if "item1room1" in inventoryitem1["unlocks"]:
                    ...
                    print(
                        random.choice(dialog["pickupkey"]).format("Key (Room1 LockBox)")
                    )
            ...
            if (
                "Key (Room1 LockBox)" in inventoryitem5["items"]
                or "boxopenedroom1" in inventoryitem5["unlocks"]
            ):
                if (
                    "boxopenedroom1" in inventoryitem5["unlocks"]
                    and "room1paper" not in inventoryitem5["unlocks"]
                ):
                    print(
                        random.choice(
                            [
                    ...
                    "boxopenedroom1" not in inventoryitem5["unlocks"]
                    and "room1paper" not in inventoryitem5["unlocks"]
                ):
                    print(
                        random.choice(
